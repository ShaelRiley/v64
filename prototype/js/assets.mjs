...
const paletteBytes = readFileSync(new URL("../../assets/palettes/v64-p256-candidate-1.rgb", import.meta.url));
const paletteMeta = JSON.parse(readFileSync(new URL("../../assets/palettes/v64-p256-candidate-1.json", import.meta.url), "utf8"));
...
if (paletteBytes.length !== 768 || paletteMeta.colors?.length !== 256) throw new Error("Invalid bundled V64 master-palette candidate");
